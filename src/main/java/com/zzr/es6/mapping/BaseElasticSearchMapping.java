...
import com.zzr.core.exceptions.GetMappingFailedException;
...
public abstract class BaseElasticSearchMapping implements IElasticSearchMapping {
    private final String indexType  = ESConstant.INDEX_TYPE;
    private final Version version = ESConstant.VERSION;

    public BaseElasticSearchMapping() {
    }
